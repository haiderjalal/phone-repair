...
export default function Home() {
    ...
    return (
        <>
        <Layout headerStyle={3} footerStyle={3} breadcrumbTitle="Console Repair">
            ...
            <div className="container">
                <div className="row">
                    <div className="col-xl-8 col-lg-7">
                        <div className="service-details__left">
                            <div className="service-details__img">
                                <img src="assets/images/services/console-service-top.jpg" alt=""/>
                            </div>
                            <h3 className="service-details__title-1">Console Repair</h3>

                            <p className="service-details__text-1">Professional repair services for all gaming consoles and handhelds</p>
                            <p className="service-details__text-2">At Lambton Phones, we specialize in repairing all types of gaming devices including PlayStation, Xbox, Nintendo Switch, and other handheld gaming systems. Our skilled technicians can fix a variety of issues to get you back to gaming as quickly as possible.</p>
                  ...
                  <li>
                    ...
                    <p style={{ color: 'var(--erepair-gray)', fontFamily: 'var(--erepair-font)' }}>
                      Controller repairs and replacements
                    </p>
                  </li>
                  <li>
                    <div className="icon">
                    ...
                    <p style={{ color: 'var(--erepair-gray)', fontFamily: 'var(--erepair-font)' }}>
                      HDMI port and power supply issues
                    </p>
                  </li>
                  <li>
                    <div className="icon">
                  ...
                  <li>
                    ...
                    <p style={{ color: 'var(--erepair-gray)', fontFamily: 'var(--erepair-font)' }}>
                      System cooling and overheating solutions
                    </p>
                  </li>
                </ul>
                                    ...
                                    <div className="col-xl-6">
                                        <div className="service-details__img-box-single">
                                            <div className="service-details__img-box-img">
                                                <img src="assets/images/services/console-repair.jpg"
                                            ...
                                            <div className="service-details__img-box-content">
                                                <div className="service-details__img-box-content-icon-and-title">
                                                    ...
                                                    <h3 className="service-details__img-box-content-title">Console Repair
                                                    </h3>
                                                </div>
                                                <p className="service-details__img-box-content-text">  We diagnose and repair hardware issues with your gaming console to restore
                          full functionality and performance.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="col-xl-6">
                                        <div className="service-details__img-box-single">
                                            <div className="service-details__img-box-img">
                                                <img src="assets/images/services/controller-repair.jpg"
                                                    alt="" width={410} height={300}/>
                                            </div>
                                            <div className="service-details__img-box-content">
                                                <div className="service-details__img-box-content-icon-and-title">
                                                    ...
                                                    <h3 className="service-details__img-box-content-title">Controller Repair</h3>
                                                </div>
                                                <p className="service-details__img-box-content-text">   Fix joystick drift, button issues, and other controller problems with our
                          expert repair service.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div className="cta-one__inner">
                    ...
                    <div className="section-title text-left">
                        ...
                        <div className="section-title__title-box sec-title-animation animation-style2">
                            <h2 className="section-title__title title-animation">Expert Console Repair<br/> Services Available
                            </h2>
                        </div>
                    </div>
